...
# ref: `data` and `data1` are adapted from <http://www.worldclimate.com>
# ref: http://www.investopedia.com/terms/m/mean.asp
# ref: http://www.investopedia.com/terms/v/variance.asp
...
describe 'mean' do
  it "Example cases" do
    ...
    expect(mean("Beijing", data)).to eq(52.416666666666664)
  end
end

describe 'variance' do
  it "Example cases" do
    expect(variance("London", data)).to eq(57.428333333333335)
    expect(variance("Beijing", data)).to eq(4808.37138888889)
  end
end
